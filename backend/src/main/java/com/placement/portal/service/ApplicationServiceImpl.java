...
public class ApplicationServiceImpl implements ApplicationService {
        ...
        /*
         * @Override
         * public List<ApplicationResponseDTO> getApplicationsByCompany(Authentication
         * authentication){
         * String email = authentication.getName();
         * Company company = companyRepository.findByEmail(email)
         * .orElseThrow(() -> new
         * ResourceNotFoundException("Company not found with email: "));
        ...
        public ApplicationResponseDTO updateStatus(Long applicationId, String status) {
                ...
                Notification notification = Notification.builder()
                                ...
                                .message("Your application for " + jobTitle + " at " + companyName
                                                + " has been marked as: " + displayStatus)
                                .isRead(false)
                                .build();
